...
export const PRODUCTS: Product[] = [
  // 熨斗系列(小)
  {
    ...
    volume: '30ml',
    pv: 2533,
    ingredients: '維他命B5、蘆薈汁葉萃取液',
    usage: '增強（強化）皮膚防禦力，舒緩肌膚、水嫩、光滑',
    instructions: '微整系列第1瓶，0號是一道防護膜，早、晚潔膚後，取適量塗抹於臉上',
    storage: '存放於陰涼乾燥處，避免陽光直射',
    precautions: [
      '維他命B5是一種極度溫和、親膚性極佳的成分，分子非常小',
      '能直接穿透角質層為肌底解渴'
    ]
  },
  {
  ...
  },
  {
    ...
    volume: '30ml',
    pv: 2250,
    ingredients: '歐錦葵花萃取液、海帶萃取、玻尿酸、維他命原B5',
  ...
  },
  {
    ...
    volume: '30ml',
    pv: 2250,
    ingredients: '夏威夷堅果油、蘆薈汁葉萃取液、葡萄籽萃取液',
  ...
  },
  {
    ...
    volume: '30ml',
    pv: 2250,
    ingredients: '玻尿酸、龍血樹葉萃取、蘆薈汁葉萃取液、銀杏萃取液',
  ...
  },
  {
    ...
    instructions: '早上潔膚後，6號使用完後取適量7號均勻塗抹於臉上，可搭配在任一系列保養的最後一道，作為日常防曬使用',
    storage: '存放於陰涼乾燥處，避免陽光直射',
  ...
  // 都都好系列 (38系列)
  {
    ...
    volume: '30ml',
    pv: 2250,
    usage: '具有鎮定安撫皮膚表皮層的效用。',
    ingredients: '金盞花萃取、蘆薈汁葉萃取液、玻尿酸',
    instructions: '早晚潔膚後，取適量38-1塗抹全臉，快速均勻勿拍打按摩。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '金盞花萃取具備天然抗菌與抑制發炎因子的能力，能幫助調理油痘肌，減輕暗瘡紅腫問題',
      '幫助調理肌膚的油水平衡，提升角質層的含水量，強化肌膚屏障，同時改善毛孔粗大'
    ]
  },
  {
    id: '38-2-都都好-m',
    ...
    volume: '30ml',
    pv: 2250,
    usage: '適用於油性肌膚、幫助肌膚油水平衡，改善暗沉。',
    ingredients: '海洋小白菊、玻尿酸',
    instructions: '擦完38-1後取適量38-2塗抹全臉，快速均勻勿拍打按摩。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '海洋小白菊能改善肌膚乾燥、泛紅與發炎不適，助於促進天然保濕因子形成',
      '修復角質層間隙，讓肌膚柔軟平滑，為受損的肌膚屏障多添一層保護膜，維持整體膚況穩定'
    ]
  },
  {
    id: '38-3-都都好-m',
    ...
    volume: '30ml',
    pv: 2250,
    usage: '安撫油性痘痘肌膚，使油性痘痘不舒服之肌膚恢復穩定，任何肌膚均可用。',
    ingredients: '去離子水、德國洋甘菊萃取、甘草萃取',
    instructions: '擦完38-2後取適量38-3塗抹全臉，快速均勻勿拍打按摩。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '德國洋甘菊萃取具有非常溫和而強大的護膚效果，幫助緩解肌膚紅腫、刺激、發癢，有很強的抗發炎作用',
      '減少皮膚中的發炎介質，加速微損傷皮膚的癒合'
    ]
  },
  {
    id: '38-4-都都好-m',
    ...
    volume: '60ml',
    pv: 2250,
    usage: '調理肌膚油水平衡、舒緩肌膚不適感，修護皮膚。',
    ingredients: '蘆薈萃取液、銀杏萃取液、海藻醣',
    instructions: '早晚使用，擦完38-3後每天晚上將38-4倒在化妝棉上濕敷痘痘處10分鐘，嚴重者早中晚各一次。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '海藻醣具有極強的親水性，不會有黏膩感、無刺激性、無致敏性，有「天然生物防護因子」的美譽',
      '對於痘痘、粉刺能穩定肌膚屏障，幫助減少自由基引起的皮膚微炎症'
    ]
  },
  {
    id: '38-5-都都好-m',
    ...
    volume: '50ml',
    pv: 2250,
    usage: '調理肌膚油水平衡、平衡肌膚油脂分泌，使肌膚清爽。',
    ingredients: '蘆薈汁葉萃取液、維他命E、金縷梅萃取液',
    instructions: '擦完38-4後取適量38-5塗抹全臉，快速均勻勿拍打按摩。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '金縷梅萃取液能收斂皮脂腺開口，幫助毛孔緊緻，可幫助舒緩痘痘、粉刺、輕微紅腫',
      '有一定的抗菌效果，能降低肌膚表面的細菌量'
    ]
  },
  {
    id: '38-6-都都好-m',
    ...
    volume: '30ml',
    pv: 2250,
    usage: '內有人蔘萃取液，能淡化改善暗沉，長時間使用能使肌膚嫩白。',
    ingredients: '人蔘萃取液、蘆薈萃取液、維他命E',
    instructions: '擦完38-5後取適量38-6塗抹全臉，快速均勻勿拍打按摩。',
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '人蔘富含人蔘皂苷，能深入肌底激活細胞，提升肌膚代謝力',
      '塗抹在肌膚上能快速形成一層「隱形防護層」，有效隔離外界刺激，如污染、灰塵、紫外線等，提升肌膚自我防禦力'
    ]
  },
  {
    id: '38-7-都都好-m',
    ...
    storage: '存放於陰涼乾燥處，避免陽光直射及潮濕環境。',
    precautions: [
      '維他命C淡化已形成的色素，是極佳的自由基清除劑，對於紅腫、炎症性痘痘有一定的抗炎緩和效果',
      '能有效促進傷口癒合，幫助修復受損組織'
    ]
  },
  {
